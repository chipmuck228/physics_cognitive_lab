    ...
    <div className="space-y-4">
      <Card className="space-y-3 p-4">
        <p className="text-xs font-medium uppercase tracking-[0.14em] text-[var(--ink-muted)]">
          Exam {completedCount + 1} of {totalCount}
        </p>
      ...
      <Card className="space-y-5 p-4">
        ...
        <fieldset className="space-y-3">
          <legend className="text-sm font-medium text-[var(--ink)]">
            2. What physical relationship should you think about?
          </legend>
          <div className="grid gap-2">
        ...
        <div className="space-y-2">
          <label htmlFor={`${question.id}-reasoning`} className="text-sm font-medium text-[var(--ink)]">
        ...
        <div className="flex items-center justify-between gap-3">
          <p className="text-xs text-[var(--ink-muted)]">
            The exam stores both your answer and your reason.
          </p>

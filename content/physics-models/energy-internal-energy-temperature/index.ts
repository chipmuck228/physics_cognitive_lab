...
export const energyInternalEnergyTemperatureModel: PhysicsModel = {
  id: MODEL_ID,
  title: MODEL_TITLE,
...
export {
  extractEnergyInternalTemperatureSignals,
...
export { energyInternalEnergyTemperatureAssessmentOverlay } from "./assessment-overlay";
export {
